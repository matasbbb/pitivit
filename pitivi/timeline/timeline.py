...
PreferencesDialog.addNumericPreference('imageClipLength',
    section=_("Behavior"),
    label=_("Image clip length"),
    description=_("Default clip length (in miliseconds) of image."),
    lower=1)
...
## Drag and Drop callbacks
    ...
    def _create_temp_source(self, x, y):
        ...
        for info in infos:
            ...
            #Set image duration
            #FIXME after Materials is merged change to check if image
...
## ToolBar callbacks
    ...
    def _trackObjectAddedCb(self, source, trackobj):
        ...
        #Set length of source if it is image
        if source.is_image():
